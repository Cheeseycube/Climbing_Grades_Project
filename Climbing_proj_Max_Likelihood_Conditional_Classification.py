...
labels = ['small', 'big']
df['Extreme_Crimps_Binned'] = pd.cut(df['Crimps_Category_4'], bins = ExtremeCrimpsBins, labels = labels, include_lowest = True)
df["Extreme_Crimps_Binned"].value_counts().sort_index().plot(kind = "bar", title = "Binned Crimps_Category_4 Distribution")
plt.show()
